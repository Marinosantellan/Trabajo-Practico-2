...
int 		ADT_Track_compare_by_genre (const ADT_Track_t *, const ADT_Track_t *);
status_t 	ADT_Track_print_as_csv(const ADT_Track_t *, const char *, FILE *);
status_t 	ADT_Track_print_as_xml(const ADT_Track_t *, const size_t *, FILE *);
/************************************PROTOTIPOS************************************/
